    ...
    for zmienna in parametry[par]:
        ...
        if par == 'prob_in':    
            ...
            if os.path.isfile(name):
                ...
                plik.write('\n')
            if n_loop==1:
                number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, zmienna, max_humans, mask, virus, virus_death, virus_trans,status_I, factor_mask, prob_I, max_prob_I, keep)
                print()
                WYNIKI=[iS,iI,stanI[-1],oI,mc]
            ...
            if n_loop==1:
                ...
                for k in range(n_loop):
                    ...
                    oI... ilosc chorych na wyjsciu
                    mc... ilosc osob w maskach'''
                    number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, zmienna, virus, virus_death, virus_trans,status_I, factor_mask, prob_I, max_prob_I, keep)
                    print(number_step[-1])
                    WYNIKI=[iS,iI,stanI[-1],oI,mc]
                    WYNIKI=",".join(map(str,WYNIKI))
                    plik.write(WYNIKI)
            ...
            if n_loop==1:
                ...
                for k in range(n_loop):
                    ...
                    oI... ilosc chorych na wyjsciu
                    mc... ilosc osob w maskach'''
                    number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, mask, virus, zmienna, virus_trans,status_I, factor_mask, prob_I, max_prob_I, keep)
                    WYNIKI=[iS,iI,stanI[-1],oI,mc]
                    WYNIKI=",".join(map(str,WYNIKI))
                    plik.write(WYNIKI)
                    plik.write('\n')
            ...
            if os.path.isfile(name):
                ...
                plik.write('\n')
            if n_loop==1:
                number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, mask, virus, virus_death, zmienna,status_I, factor_mask, prob_I, max_prob_I, keep)
                WYNIKI=[iS,iI,stanI[-1],oI,mc]
                WYNIKI=",".join(map(str,WYNIKI))
                plik.write(WYNIKI)
                plik.write('\n')
            ...
            if os.path.isfile(name):
                ...
                plik.write('\n')
            if n_loop==1:
                number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, mask, virus, virus_death, virus_trans,zmienna, factor_mask, prob_I, max_prob_I, keep)
                WYNIKI=[iS,iI,stanI[-1],oI,mc]
                WYNIKI=",".join(map(str,WYNIKI))
                plik.write(WYNIKI)
                plik.write('\n')
            ...
            if os.path.isfile(name):
                ...
                plik.write('\n')
            if n_loop==1:
                number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, mask, virus, virus_death, virus_trans,status_I, zmienna, prob_I, max_prob_I, keep)
                WYNIKI=[iS,iI,stanI[-1],oI,mc]
                WYNIKI=",".join(map(str,WYNIKI))
                plik.write(WYNIKI)
                plik.write('\n')
            ...
            if n_loop==1:
                ...
                for k in range(n_loop):
                    ...
                    oI... ilosc chorych na wyjsciu
                    mc... ilosc osob w maskach'''
                    number_step, stanI, mc, iI, iS, oI = o.Motion(g, steps, prob_in, max_humans, mask, virus, virus_death, virus_trans,status_I, factor_mask, zmienna, max_prob_I, keep)
                    WYNIKI=[iS,iI,stanI[-1],oI,mc]
                    WYNIKI=",".join(map(str,WYNIKI))
                    plik.write(WYNIKI)
                    plik.write('\n')
